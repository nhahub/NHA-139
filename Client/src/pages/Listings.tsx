  ...
  const fetchRestaurants = () => {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (cityFilter) {
          places = places.filter((place: Restaurant) => 
            place.city && place.city.toLowerCase() === cityFilter.toLowerCase()
          );
        ...
        <div className="container mx-auto">
          ...
          <div className="flex items-center gap-2 ml-[60px]">
            <span className='text-gray-400 text-2xl mt-2'>
              {hasActiveFilters ? 'Showing Filtered Results' : 'Showing All results'}
            </span>
            {hasActiveFilters && (
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center min-h-[400px] px-4">
          <div className="text-center max-w-md">
            ...
            <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">No Places Found</h3>
